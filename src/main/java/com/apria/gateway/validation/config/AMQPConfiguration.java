	...
	CamelContextConfiguration contextConfiguration(
		...
		return new CamelContextConfiguration() {
			...
			public void beforeApplicationStart(CamelContext context) {
				/*
				 * // your custom configuration goes here ThreadPoolProfile threadPoolProfile =
				 * new ThreadPoolProfile(); threadPoolProfile.setId(MY_DEFAULT_PROFILE);
				 * threadPoolProfile.setPoolSize(10); threadPoolProfile.setMaxPoolSize(15);
				 ...
				 * threadPoolProfile);
				 */
				ConnectionFactory connectionFactory = new JmsConnectionFactory(user, password, url);
